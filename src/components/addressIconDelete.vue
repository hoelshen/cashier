...
<template>
    <div class="address-wrap">
        <div class="address-select">
            ...
            <el-select v-model="select.provinceCode" placeholder="请选择省份" @change="getAllData" clearable >
        ...
        <div class="address-select">
            ...
            <el-select v-model="select.cityCode" placeholder="请选择城市" @change="getAllData" clearable>
        ...
        <div class="address-select">
            ...
            <el-select v-model="select.areaCode" placeholder="请选择区域" @change="getAllData" clearable>
...
export default {
    ...
    methods: {
        ...
        getAllData() {
            ...
            if(!this.select.provinceCode){
                this.select.areaCode = '';
                this.select.cityCode = '';
            }
            if(!this.select.cityCode){
                this.select.areaCode = '';
            }
        },
        getAddress() {        
